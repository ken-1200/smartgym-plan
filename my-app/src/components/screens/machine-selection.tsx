    ...
    <div className="container mx-auto px-4 py-8 min-h-screen flex flex-col">
      <div className="max-w-4xl w-full mx-auto flex-1 flex flex-col">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">利用可能なジムマシンを選択してください（複数選択可）</p>
        </div>
          ...
          {machines.map((machine) => (
            <Card
              ...
              className={`cursor-pointer transition-all ${
                selectedMachineIds.includes(machine.id) ? 'ring-2 ring-primary' : ''
              }`}
            ...
            >
              ...
              <CardContent>
                <div className="space-y-2 text-sm text-muted-foreground">
                  <p>部位: {machine.part}</p>
                  <p>
                    重量範囲: {machine.minWeight}kg - {machine.maxWeight}kg
                  </p>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="flex justify-between mt-8">
          ...
          <Button onClick={handleNext} disabled={selectedMachineIds.length === 0} className="flex items-center gap-2">
            次へ
