    ...
    <div className="container mx-auto px-4 py-8 flex flex-col items-center justify-center min-h-screen">
      <div className="max-w-4xl w-full space-y-8">
        <div className="text-center space-y-4">
          ...
          <p className="text-xl text-muted-foreground">あなただけのパーソナライズされたワークアウトプランを作成</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>利用可能なジムマシンを選択してください</CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>あなたの経験レベルと目標を入力します</CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>最適な重量、回数、セット数を自動計算</CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>タイマー付きでトレーニングを管理</CardDescription>
            </CardHeader>
          </Card>
        </div>
