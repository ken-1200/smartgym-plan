...
import { UserProfile, Machine, WorkoutPlan } from '@/lib/types'
import { machines } from '@/lib/machine-data'
import { calculateWorkoutPlan } from '@/lib/workout-calculator'
import TopScreen from '@/components/screens/top-screen'
import MachineSelection from '@/components/screens/machine-selection'
import ProfileInput from '@/components/screens/profile-input'
import MenuProposal from '@/components/screens/menu-proposal'
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-zinc-50 to-zinc-100 dark:from-zinc-900 dark:to-zinc-950">
      ...
      {currentScreen === 'machine-selection' && (
        <MachineSelection 
          machines={machines}
          onNext={handleMachineSelect}
          onBack={handleBack}
        />
      )}
      {currentScreen === 'profile-input' && (
        <ProfileInput 
